...
public class AuthorServiceImpl implements AuthorService {
    ...
    private final static String AUTHORS_FILE_PATH = "D:\\Spring\\ADVQuering\\src\\main\\resources\\files\\authors.txt";
    ...
    @Override
    public List<String> searchForAuthors(String pattern) {

        return this.authorRepository.searchAuthor(pattern)
                .stream()
